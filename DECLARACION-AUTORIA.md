...
Yo, **Raul Cruz Acosta**, conocido públicamente y en plataformas de desarrollo
bajo el apodo **`esraderey`**, declaro de forma expresa, voluntaria y bajo mi
propia responsabilidad que soy el **único autor y titular originario** de la
obra denominada **Z-Space Core**, incluyendo, sin limitación:
